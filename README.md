# Spatio-Temporal-Drought-Assessment
An automated Python pipeline processing 45 years of high-resolution satellite data to compute spatio-temporal drought indices and map statistical climate trends.
